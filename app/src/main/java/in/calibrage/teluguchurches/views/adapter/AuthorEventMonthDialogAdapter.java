...
/**
 * This adapter is helpfull to show the particular pastor evnets information in dialog box
 */

public class AuthorEventMonthDialogAdapter extends RecyclerView.Adapter<AuthorEventMonthDialogAdapter.ViewHolder> {
     ...
     * @param events
     */
    public AuthorEventMonthDialogAdapter(Context mContext, GetEventByDateAndChurchIdResponseModel events) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        AuthorEventMonthDialogAdapter.ViewHolder mh = new AuthorEventMonthDialogAdapter.ViewHolder(v);
        return mh;
    }
