...
public class ChurchDocumentFragment extends BaseFragment implements PostDocumentAdapter.OnCartChangedListener {
        ...
        mSubscription = service.GetPostByChurchId(object)
                ...
                .subscribe(new Subscriber<PostImageResponseModel>() {
                    ...
                    public void onNext(PostImageResponseModel mResponse) {
                        ...
                        adapter.setOnCartChangedListener(ChurchDocumentFragment.this);
