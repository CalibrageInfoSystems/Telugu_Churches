...
public class ChurchVideoFragment extends BaseFragment implements PostVideoAdapter.OnCartChangedListener {
    ...
    private void getPostByChurchId() {
        /*
         * API to get post by churchID
         * */
        ...
        mSubscription = service.GetPostByChurchId(object)
                ...
                .subscribe(new Subscriber<PostImageResponseModel>() {
                    ...
                    public void onNext(PostImageResponseModel mResponse) {
                        ...
                        for (int i = 0; i < mResponse.getListResult().size(); i++) {
                            if (mResponse.getListResult().get(i).getMediaTypeId().equals(4) && mResponse.getListResult().get(i).getEmbededUrl() != null && !mResponse.getListResult().get(i).getEmbededUrl().equalsIgnoreCase("")) {
    ...
    private JsonObject getPostByAuthorIdObject() {
        ...
        mRequest.setMediaTypeId(4);
        mRequest.setPageIndex(pageIndex);
        mRequest.setPageSize(100);
