...
/**
 * This adapter is helpfull for searching in categories in home view
 */

public class SearchImageAdapter extends RecyclerView.Adapter<SearchImageAdapter.ViewHolder> {
    private Context context;
    GetCategory mResponse;
    private SearchImageAdapter.OnCartChangedListener onCartChangedListener;
     ...
     * @param mResponse
     */
    public SearchImageAdapter(Context context, GetCategory mResponse) {
     ...
     * */
    @Override
    public SearchImageAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.gridview_adapter, viewGroup, false);
        return new SearchImageAdapter.ViewHolder(view);
    }
     ...
     * */
    @Override
    public void onBindViewHolder(SearchImageAdapter.ViewHolder viewHolder, final int i) {
     ...
     */
    public void setOnCartChangedListener(SearchImageAdapter.OnCartChangedListener onCartChangedListener) {
