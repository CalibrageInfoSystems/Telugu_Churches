...
import in.calibrage.teluguchurches.views.Activities.ApplyActivity;
...
import in.calibrage.teluguchurches.views.adapter.NotificationReadScreenAdapter;
...
public class ReadNotificationFragment extends BaseFragment implements NotificationReadScreenAdapter.OnCartChangedListener {

    public static final String TAG = ReadNotificationFragment.class.getSimpleName();
    ...
    private String authorizationToken, generatedOnDate, dateandtime;
    private Integer NotificationId, pageIndex = 1, listPosition = 0, pazeSize = 100, Position;
    private View rootView;
    Boolean mBoolean;
    NotificationReadScreenAdapter adapter;
    ...
    private void getNotification() {
        ...
        mSubscription = service.GetReadNotification(object, authorizationToken)
                ...
                .subscribe(new Subscriber<GetNotificationResponseModel>() {
                    ...
                    public void onNext(GetNotificationResponseModel mResponse) {
                        ...
                        if (mResponse.getIsSuccess()) {
                            ...
                            adapter = new NotificationReadScreenAdapter(mContext, listResults, notificationRecyclerView);
                            notificationRecyclerView.setAdapter(adapter);
                            //notificationRecyclerView.scrollToPosition(listResults.size() - 10);
                            adapter.setOnCartChangedListener(ReadNotificationFragment.this);
                            handler = new Handler();
                        }
