...
/*
* This adapter is helpfull to show commnets in screen's
* */
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.MyHolder> {
     ...
     * @param comingForm
     */
    public CommentAdapter(Context context, GetPostByIdResponseModel dataList, String comingForm, ViewAllRepliesResponseModel mDataList) {
