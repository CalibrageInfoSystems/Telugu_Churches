...
public class ChurchImageFragment extends BaseFragment implements PostImageAdapter.OnCartChangedListener {
                ...
                .subscribe(new Subscriber<PostImageResponseModel>() {
                    ...
                    public void onNext(PostImageResponseModel mResponse) {
                        if (mResponse.getIsSuccess()) {
                            ...
                            cAdapter.setOnCartChangedListener(ChurchImageFragment.this);
    ...
    public void setCartClickListener(String status, int position) {
        if (status.equalsIgnoreCase("imagePosition")) {
             ...
             * */
            /*
             * intent value passing to ImageViewActivity
             * @param  postId
             * @param  image
           */
