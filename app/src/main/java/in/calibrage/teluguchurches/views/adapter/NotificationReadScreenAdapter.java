...
/**
 * This adapter is helpfull to show notifications in Read Notifications view
 */
public class NotificationReadScreenAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private NotificationReadScreenAdapter.OnLoadMoreListener onLoadMoreListener;
     ...
     * @param myDataSet
     */
    public NotificationReadScreenAdapter(Context mContext, List<T> myDataSet, RecyclerView notificationRecyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.adapter_notification_read, parent, false);

            vh = new NotificationReadScreenAdapter.TextViewHolder(v);
        } else {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.progress_item, parent, false);

            vh = new NotificationReadScreenAdapter.ProgressViewHolder(v);
        }
        return vh;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof NotificationReadScreenAdapter.TextViewHolder) {
            if (listResults.get(position).getIsRead()) {
                ((TextViewHolder) holder).card_view.setVisibility(View.VISIBLE);
                ...
                ((TextViewHolder) holder).card_view.setVisibility(View.GONE);
            }
