...
// This adapter is helpfull to show events commnets replies in Evnets Detailview


public class EventsViewAllRepliesAdapter extends RecyclerView.Adapter<EventsViewAllRepliesAdapter.MyViewHolder> {
    ...
    public EventsViewAllRepliesAdapter(Context context, GetUpComingEventsModel dataList, String comingForm, EventViewAllRepliesResponseModel mDataList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new EventsViewAllRepliesAdapter.MyViewHolder(view);
    }
